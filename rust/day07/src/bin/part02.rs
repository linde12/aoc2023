...
impl Hand {
    ...
    fn get_hand_type(cards: &Vec<u8>) -> HandType {
        ...
        let jokers = occurrences.remove(&0).unwrap_or(0);
...
#[test]
fn it_works_basecase() {
    let input = r#"32T3K 765
T55J5 684
KK677 28
KTJJT 220
QQQJA 483"#;
    assert_eq!(process(input).unwrap(), "5905".to_owned());
}

#[test]
fn it_works_high_occurrences_first() {
    let input = r#"JKKK3 20
Q2222 5"#;
